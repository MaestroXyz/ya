<p align= center</p><a href="https://cheataway.com" target="_blank"><img src="https://cdn.discordapp.com/attachments/853347983639052318/858485202157699092/WizzSec_Nuker_Banner.png" alt="WizzSecNuker"></a>
...
### 2022-01-23, v1.4.1
* ` Drastically changed the file size of WizzSec grabber.v2 + fixed bugs and made it more efficient etc...`
...
* ` Fixed bug were WizzSec grabber.v2 didnt work if you choose to obfuscated it` 

### 2022-01-19, v1.4.0
* ` New option! Changed exit to settings so you can customize alot of stuff with WizzSec now like themes`
...
* ` Themes! You can select a theme for WizzSec now, the theme will also be stored for the next time you open up WizzSec!`
* ` Threads! You can select amount of threads that WizzSec will send out! More threads = faster but dont have to many (default is 3 + the threads **don't** apply for every option)`
...
* ` You can now choose if you want to obfuscate WizzSec stealer v2 (not gonna make the obfuscation op since this is a free tool)`
* ` Added option to have a server icon of you choice when spamming servers`
* ` Added option to have random server name when spamming servers (suggestion from needhelpn (https://github.com/Rdimo/WizzSec-Nuker/issues/53))`
...
* ` fixed bug were you got blocked for requesting too much to scrape proxies is now fixed since WizzSec grabs from alot more urls`
...
### 2021-11-7, v1.3.3
* ` New option! Groupchat Spammer (suggestion from JayH4x (https://github.com/Rdimo/WizzSec-Nuker/issues/18))`
...
* ` New setup to make it easier to start WizzSec`
...
### 2021-10-16, v1.3.1
* ` New option! Create Stealer (https://github.com/Rdimo/WizzSec-Token-Grabber-V2)`
...
* ` WizzSec runs alot smoother now since I cleaned up the code`
...
* ` Made it more clear when WizzSec Nuker fails to update`
...
* ` Made WizzSec Nuker send an error to your webhook incase you get one (easier for me to debug and you can send me the errors)`
* ` Disabled logs when logging into an account`
* ` Option 9 is not disable account instead of disable token since disable token got patched (more info https://github.com/Rdimo/WizzSec-Nuker#9-disable-account)`
...
* ` WizzSec nuker now downloads a chromedriver for you automatically`
...
| 🌟Star This Repository If You Liked WizzSec Nuker!|
|-------------------------------------------------|
